...
function LatestBlogs() {
    ...
    <div className='latestBlogs-section'>
        <div className='latestBlogs-header'>
            ...
            <p className='latestBlogs-header__desc'>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature</p>
        </div>
        <div className='latestBlogs-blogsArea'>
            <div className='blog-card'>
                <div className='blog-card__content'>
                    ...
                    <p className='blog-card__content__desc'>Lorem ipsum dolor sit amet, consecteturl adipisl elit, sed do eiusmod tempor incidio ut labore et dolore magna aliqua.</p>
                </div>
