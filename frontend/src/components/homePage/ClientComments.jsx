...
const commentsData = [
    {
        name: "PHOENIX BAKER",
        role: "Client",
        comment: "Lorem ipsum dolor sit amet, conse adipisic elit, sed do eiusmod tempo incididunt ut labore et dolore.",
        image: UserImage1
    },
    {
        name: "JEMALIKO 123",
                ...
                <div className='carousel-wrapper'>
                    ...
                    }}>
                    {
                        infinity_comments.map((card, index) => (
                            <div className='clientComments-card' key={index}>
                                <div className='clientComments-card__user'>
                                    ...
                                    <div className='clientComments-card__user__info'>
                                        <p className='clientComments-card__user__info__name'>{card.name}</p>
                                        <p className='clientComments-card__user__info__role'>{card.role}</p>
                                    </div>
                                </div>
